...
import 'package:fastcampus_toss/common/dart/extension/num_duration_extension.dart';
import 'package:fastcampus_toss/screen/main/tab/tab_item.dart';
import 'package:fastcampus_toss/screen/main/tab/tab_navigator.dart';
...
class MainScreenState extends State<MainScreen> with SingleTickerProviderStateMixin, AfterLayoutMixin {
  ...
  FutureOr<void> afterFirstLayout(BuildContext context) {
    //TODO 여기서 로그인, 로딩등 스플래시때 데이터를 가져올 수 있음
    delay(() {
